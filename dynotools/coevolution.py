...
class Coevolution(object):
    ...
    def run_hhblits(self):
        ...
        hhr="%s-%d.hhr"%(self._pdbID,self._nthreads)
        a3m="%s-%d.a3m"%(self._pdbID,self._nthreads)
        oa3m="%s.a3m"%(self._pdbID)
    ...
    def run_ccmpred_gpu():
        ...
        start = timeit.default_timer()
        self._logger.info("Running CCMPRED on %s .........."%(self._pdbID))
    ...
    def run_coevolution(self):
        ...
        self._args = argParser.opts_coevolution()
        self._pdbID = self._args.pdbid
        ...
        self._file_aln = "%s.aln"%(self._pdbID)
        self._file_ccm = "%s.mat"%(self._pdbID)
        self._file_fasta="%s.fasta"%(self._pdbID)

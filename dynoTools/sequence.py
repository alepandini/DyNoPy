...
'''
    ...
    @author        : Sarath Chandra Dantu
     ...
     Copyright (C) 2018-2019 Sarath Chandra Dantu & Alessandro Pandini

     This file is part of: Design of Protein Dynamics package (DPD)

     DPD is a free software: you can redistribute it and/or modify
     ...
     along with DPD.  If not, see <http://www.gnu.org/licenses/>.
